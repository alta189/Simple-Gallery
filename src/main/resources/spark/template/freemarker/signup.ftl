...
<head>
	<meta charset="utf-8">
	<title>${gallery_name} | Sign Up</title>
...
<body class="uk-height-1-1">
	...
	<div class="uk-vertical-align uk-text-center uk-height-1-1">
		<div class="uk-vertical-align-middle" style="width: 250px;">
			<form class="uk-panel uk-panel-box uk-form" id="signup-form">
				<div class="uk-form-row">
					<h4>Create Account</h4>
				</div>
				<div class="uk-form-row">
					<input class="uk-width-1-1 uk-form-large" type="text" id="name" placeholder="Full Name">
				</div>
				<div class="uk-form-row">
					<input class="uk-width-1-1 uk-form-large" type="text" id="email" placeholder="Email">
				</div>
				<div class="uk-form-row">
					<input class="uk-width-1-1 uk-form-large" type="text" id="confirm-email" placeholder="Confirm Email">
				</div>
				<div class="uk-form-row">
					<input class="uk-width-1-1 uk-form-large" type="password" id="password" placeholder="Password">
				</div>
				<div class="uk-form-row">
					<input class="uk-width-1-1 uk-form-large" type="password" id="confirm-password" placeholder="Confirm Password">
				</div>
				<div class="uk-form-row">
